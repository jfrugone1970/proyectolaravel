                ...
                <div class="row">
                            <div class="col-md-6">
                                <div class="card card-chart">
                                    <div class="card-header">
                                        <h4 class="text-center">Compras Detalle</h4>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="card card-chart">
                                    <div class="card-header">
                                        <h4 class="text-center">Ventas Detalle</h4>
                                    </div>
                                    <div class="card-content">
                                        <div class="ct-chart">
                                            <canvas id="ventas">                                                
        ...
        methods : {
            ...
            loadCompras(){
                ...
                me.compras.map(function(x){
                    ...
                    me.varProductoCompra.push(x.nombre);
                });
            ...
            loadVentas(){
                ...
                me.ventas.map(function(x){
                    ...
                    me.varProductoVenta.push(x.nombre);
                });
